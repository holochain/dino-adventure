...
<div class="flex flex-col items-center tooltip tooltip-bottom" data-tip={ authoredDino.author ? `${encodeHashToBase64(authoredDino.author)} chose ${authoredDino.dino.dino_kind.type}` : "Creating..." }>
    <img
